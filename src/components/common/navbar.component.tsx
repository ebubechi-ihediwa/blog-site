    ...
    <nav className="relative w-full">
      <div className="w-full h-[70px] p-6 flex items-center justify-between md:px-10">
        <div className="w-1/2 flex items-center justify-start">
          <p className="text-[#181D27] font-bold text-[24px]">Blog Site</p>
        </div>
      ...
      <div
        className={`lg:hidden absolute top-[70px] right-0 left-0 bg-white shadow-md transform transition-all duration-300 ${
